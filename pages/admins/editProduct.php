...
$productSizes = getProductSizesById($id);
...
<div class="add w-100">
    <div class="container">
        <div class="add-inner w-100 d-flex-columns">
            ...
            <form action="actions/product/edit.php" method="POST" class="d-flex-columns" enctype="multipart/form-data">
                ...
                <div class="input__item">
                    <input type="text" name="desc" placeholder="Описание" value="<?=$product['description']?>">
                ...
                <div class="select__item">
                    ...
                    <select name="gender">
                        <?php foreach ($genders as $gender) { ?>
                            <option <?php if ( $gender['id'] === $product['gender_id'])  echo 'selected'; ?>
                ...
                <div class="select__item">
                    ...
                    <select name="color">
                        <?php foreach ($colors as $color) { ?>
                            <option <?php if ( $color['id'] === $product['color_id'])  echo 'selected'; ?>
                ...
                <div class="select__item">
                    ...
                    <select name="type">
                        <?php foreach ($types as $type) { ?>
                            <option <?php if ( $type['id'] === $product['type_id'])  echo 'selected'; ?>
                    ...
                    <label for="">Бренд</label>
                     <select name="brand">
                        <?php foreach ($brands as $brand) { ?>
                            <option <?php if ( $brand['id'] === $product['brand_id'])  echo 'selected'; ?>
                ...
                <div class="select__item">
                    ...
                    <select name="material">
                        <?php foreach ($materials as $material) { ?>
                            <option <?php if ( $material['id'] === $product['material_id'])  echo 'selected'; ?>
                ...
                <div class="select__item">
                    ...
                    <?php foreach ($sizes as $size)  { ?>
                        ...
                        <option <?php foreach($productSizes as $productSize){ if(in_array($size['id'], $productSize)){ echo "selected";}; } ?>
